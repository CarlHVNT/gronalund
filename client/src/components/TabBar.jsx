...
export function TabBar({ theme, screen, onNavigate }) {
  return (
    <div style={{ flex: 'none', height: 104, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 16px', position: 'relative', zIndex: 50, background: theme.tabBarBg }}>
