...
export function TabBar({ theme, screen, onNavigate }) {
  return (
    <div data-tour="tabs" data-tour-adjust="12 0 0 0" style={{ flex: 'none', height: 104, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 16px', position: 'relative', zIndex: 50, background: theme.tabBarBg }}>
